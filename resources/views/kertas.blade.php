...
<html>
  <head>
    <title>@yield('title', 'Aneka Jaya Plastik-Kertas')</title>
    <!-- for-mobile-apps -->
                  ...
                  <div class="agile_top_brand_left_grid1">
                    <figure>
                      <div class="snipcart-item block">
                        <div class="snipcart-thumb">
                          <a href="/single">
                            <img title=" " alt="Gajah" width="150" height="150" src="webdev_image_assets/KertasGajah.png"/>
                          </a>
                          <p>Kertas Gajah</p>
                          <h4>Rp25,000</h4>
                        </div>
                  ...
                  <div class="agile_top_brand_left_grid1">
                    <figure>
                      <div class="snipcart-item block">
                        <div class="snipcart-thumb">
                          <a href="/single">
                            <img title=" " alt="Beo" width="150" height="150" src="webdev_image_assets/KertasNasi.png"/>
                          </a>
                          <p>Kertas Nasi</p>
                          <h4>Rp12,000</h4>
                        </div>
