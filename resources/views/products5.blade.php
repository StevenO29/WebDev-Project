          ...
          <div class="cate">
            ...
            <li>
              ...
              <li>
                <!--Category 3: Cup-->
                <a href="/cup">
                  <i class="fa fa-arrow-right" aria-hidden="true"></i>Cup</a>
              </li>
                <!--SubCategory 3-->
                <ul> 
                  <li>
              ...
              <li>
                ...
                <a href="/cutleries">
                  <i class="fa fa-arrow-right" aria-hidden="true"></i>Cutleries</a>
              </li>
                <!--SubCategory 4-->
                <ul>
                  <li>
        ...
        <div class="col-md-8 products-right">
          ...
          <nav class="numbering">
            <ul class="pagination paging">
              <li>
                <a href="/products4" aria-label="Previous">
                  <span aria-hidden="true">&laquo;</span>
                </a>
              </li>
              <li>
                <a href="/products1">1<span class="sr-only">(current)</span></a>
              </li>
              <li><a href="/products2">2</a></li>
              <li><a href="/products3">3</a></li>
              <li><a href="/products4">4</a></li>
              <li><a href="/products5">5<span class="sr-only">(current)</span></a></li>
            </ul>
          </nav>
        </div>
        <div class="clearfix"></div>
